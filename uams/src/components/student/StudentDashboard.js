...
const StudentDashboard = () => {
  ...
  }, [activeTab, studentData, semesterPayments.length, otherPayments.length, currentEnrollments.length, availableCourses.length, classSchedule.length, examSchedule.length, fetchEnrollmentData, fetchSemesterEnrollments]);
      ...
      <div className="dashboard" style={{ marginTop: '60px' }}>
        ...
        {studentData && (
          <div style={{ backgroundColor: 'white', padding: '30px', borderRadius: '8px' }}>
            ...
            {activeTab === 'personal' && (
              <div className="personal-details">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', backgroundColor: '#f8f9fa', padding: '20px', borderRadius: '8px' }}>
                  ...
                  <div><strong>Admission Year:</strong> {studentData.admission_year}</div>
                </div>
              </div>
            )}
            ...
            {/* Exam Results Tab */}
            {activeTab === 'results' && (
              <ExamResults studentData={studentData} />
            )}

            {/* Inquiries Tab */}
            {activeTab === 'inquiries' && (
              <StudentInquiries studentData={studentData} />
            )}

            {/* Enrolled Modules Tab */}
            {activeTab === 'enrollment' && (
              <EnrolledModules studentData={studentData} />
            )}
